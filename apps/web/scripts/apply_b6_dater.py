# Apply B6 DateRangeFilter and B2 improvements
...
if old in c:
    c = c.replace(old, new)
    print('B6 DateRangeFilter added')
else:
    print('B6 pattern not found')
